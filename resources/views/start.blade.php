...
@section('body')
    <div class="container">
        ...
        <div id="explanation" class="row">
            ...
            <div class="col-12">
                <h4 class="detail">
                    実験は「料理探し」です。お題が10問（5種類の問題をaパターンとbパターンの2セット）出てくるので、カテゴリを駆使して料理を選んでください！
                    カテゴリの内容、レシピはともに「楽天レシピ」のデータを利用させてもらっております。以下のポイントに気をつけてください。<br><br>
                    1. 被験者の料理の腕前は関係ありません。選びたい料理を選んでください。<br>
                    2. 戻るボタンは用意されてませんが、ページを自由にもどっても大丈夫です。<br>
                    3. 料理の詳細が見れるわけではありません。写真やタイトルで判断して料理は選んでください。<br>
                    4. ある程度探して料理が見つからなかったり、選べなかった場合は料理欄上部の赤文字を押して次の問題に行って構いません。
                </h4>
            </div>
        </div>
        <div id="explanation" class="row">
