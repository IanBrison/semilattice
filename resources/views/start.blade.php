...
@section('body')
    <div class="container">
        ...
        <div id="explanation" class="row">
            ...
            <div class="col-12">
                <h4 class="detail">
                    実験は「料理探し」です。お題が10問出てくるので、カテゴリを駆使して料理を選んでください！以下のポイントに気をつけてください。<br><br>
                    ...
                    4. どうしても料理が見つからなかったり、選べなかった場合は料理欄上部の赤文字を押して次の問題に行って構いません。ですが、できれば時間をかけてでも回答してほしいです。<br>
                    5. 稀にデータが重くて遅くなることがあります。遅くても20秒以内には絶対処理は終わるので、そのときだけは我慢して待ってください。
                </h4>
            </div>
        </div>
        <div id="explanation" class="row">
